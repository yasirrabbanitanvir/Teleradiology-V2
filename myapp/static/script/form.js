...
window.onload = async () => {
  ...
  centerInput.value = sessionStorage.getItem('center_name') || localStorage.getItem('center_name') || '';
  instituteInput.value = sessionStorage.getItem('institute_name') || localStorage.getItem('institute_name') || '';
